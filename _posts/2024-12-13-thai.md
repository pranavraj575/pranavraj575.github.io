...
<div class="row mt-3">
  {% include img_light.liquid path="assets/img/aminals/thai/ms_tort.jpg"        class="col img-spacing mt-0" imgclass="spotlight" %}
  {% include img_light.liquid path="assets/img/aminals/thai/ms_torts_wife.jpg"  class="col img-spacing mt-0" imgclass="spotlight" %}
</div>
