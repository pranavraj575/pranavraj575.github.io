...
<div class="row mt-3">
  ...
  {% include img_light.liquid path="assets/img/aminals/meebis/fnaf.jpg" class="col img-spacing mt-0 serious-goose" imgclass="spotlight serious-goose" imgstyle="object-fit:contain;" %}
  {% include img_light.liquid path="assets/img/aminals/meebis/fnaf.jpg" class="col img-spacing mt-0 silly-goose" imgclass="spotlight silly-goose" title="FNAF gameplay" caption="FNAF gameplay" imgstyle="object-fit:contain;" %}
</div>
