...
<div class="row mt-3">
  ...
  {% include img_light.liquid path="assets/img/aminals/meebis/slug.jpg" class="col img-spacing mt-0" imgclass="spotlight" title="slug" %}
</div>
<div class="caption">
    snail
</div>
...
<div class="row mt-3">
  ...
  <div class="col img-spacing mt-0">
    ...
    {% include img_light.liquid path="assets/img/aminals/meebis/rotisserie2.jpg" class="col img-spacing mt-0" style="top:-1rem" imgclass="spotlight" title="rotisserie" %}
  </div>
  <div class="col img-spacing mt-0">
    ...
    {% include img_light.liquid path="assets/img/aminals/meebis/suspicious_hovercraft.jpg" class="col img-spacing mt-0" style="top:-1rem" imgclass="spotlight" title="suspicious" %}
  </div>
