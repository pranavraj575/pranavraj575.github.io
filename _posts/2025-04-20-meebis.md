...
<div class="row mt-3">
  ...
  {% include img_light.liquid path="assets/img/aminals/meebis/drinking.jpg" class="col img-spacing mt-0 silly-goose" imgclass="spotlight silly-goose" title="drinking" %}
  {% include img_light.liquid path="assets/img/aminals/meebis/drinking.jpg" class="col img-spacing mt-0 serious-goose" imgclass="spotlight serious-goose" %}
</div>
