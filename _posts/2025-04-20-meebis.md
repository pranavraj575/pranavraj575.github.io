...
<div class="row mt-3">
  ...
  {% include img_light.liquid path="assets/img/aminals/meebis/fnaf.jpg" class="col img-spacing mt-0 serious-goose" imgclass="spotlight serious-goose" style="-ms-flex:0 0 40%;flex:0 0 40%; max-width:40%;display:block;" %}
  {% include img_light.liquid path="assets/img/aminals/meebis/fnaf.jpg" class="col img-spacing mt-0 silly-goose" imgclass="spotlight silly-goose" title="FNAF gameplay" caption="FNAF gameplay" style="-ms-flex:0 0 40%;flex:0 0 40%; max-width:40%;display:block;" %}
</div>
...
<div class="row mt-3">
  ...
  {% include img_light.liquid path="assets/img/aminals/meebis/drinking.jpg" class="col img-spacing mt-0 silly-goose" imgclass="spotlight silly-goose" title="drinking" style="-ms-flex:0 0 30%;flex:0 0 30%; max-width:30%;display:block;" %}
  {% include img_light.liquid path="assets/img/aminals/meebis/drinking.jpg" class="col img-spacing mt-0 serious-goose" imgclass="spotlight serious-goose" style="-ms-flex:0 0 30%;flex:0 0 30%; max-width:30%;display:block;" %}
</div>
...
<div class="row mt-3">
  {% include img_light.liquid path="assets/img/aminals/meebis/scheming.jpg" class="col img-spacing mt-0 serious-goose" imgclass="spotlight serious-goose" style="display:block;" %}
  {% include img_light.liquid path="assets/img/aminals/meebis/scheming.jpg" class="col img-spacing mt-0 silly-goose" imgclass="spotlight silly-goose" title="scheming" style="display:block;" %}
