...
<img  id="craigory"
      style="cursor:pointer;position:fixed;bottom:50%;right:50%;z-index:1420;transform:translate(50%,50%);display:none;opacity=1;" 
...
<script>
  ...
  document.addEventListener("click", craig);
