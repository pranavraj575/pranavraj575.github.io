...
<img id="craigory" style="cursor:pointer;position:fixed;bottom:50%;right:50%;z-index:1420;transform:translate(50%,50%);display:none" src="/assets/img/aminals/bug/craig.jpg" width="100%" height="100%">
<script>
  function craig(duration=100){
    document.getElementById("craigory").style.display="inherit";
    setTimeout(function(){document.getElementById("craigory").style.display="none";}, duration);
  }
