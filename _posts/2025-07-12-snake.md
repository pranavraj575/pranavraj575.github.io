...
<div class="row mt-3">
  {% include img_light.liquid path="assets/img/aminals/snake/dc_long.jpg" class="col img-spacing mt-0" imgclass="spotlight" style="-ms-flex:0 0 45%;flex:0 0 45%; max-width:45%;" %}
