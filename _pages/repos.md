...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/polyhedra_cut_locus"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/polyhedra_cut_locus </b></a></td></tr> 
...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/aleph0_game"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/aleph0_game </b></a></td></tr> 
...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/BERTeam"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/BERTeam </b></a></td></tr> 
...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/sperners_lemon"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/sperners_lemon </b></a></td></tr> 
