...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/polyhedra_cut_locus" style="text-decoration:none;"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/polyhedra_cut_locus </b></a></td></tr> 
            <tr> <td class="p-1 pl-2 text"> Calculation of the cut locus on surfaces of polyhedra </td> </tr>
            <tr> <td class="p-1 pl-2 text"> <table><tbody><tr><td><svg style="color:#3572A5;" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-dot-fill mr-2 tmp-mr-2">
    <path d="M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z" fill="#3572A5"></path>
</svg>
...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/aleph0_game" style="text-decoration:none;"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/aleph0_game </b></a></td></tr> 
...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/BERTeam" style="text-decoration:none;"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/BERTeam </b></a></td></tr> 
...
<div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);">
    <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark"> 
        <tbody>
            <tr> <td class="p-1 pl-2 font-weight-bold"><a href="https://github.com/pranavraj575/sperners_lemon" style="text-decoration:none;"><i class="fa-brands fa-github" style="color:#420dab"></i>&nbsp;<b> pranavraj575/sperners_lemon </b></a></td></tr> 
