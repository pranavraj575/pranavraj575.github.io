        ...
        <div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);background:var(--global-pure-theme-color);">
            <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark">
                <tbody>
                    ...
                    <tr> <td class="p-1 pl-2 text"> <table><tbody><tr><td><svg style="color:#3572A5;" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-dot-fill mr-2 tmp-mr-2"> <path d="M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z" fill="#3572A5"></path> </svg> <span class="color-fg-default text-bold mr-1">Python</span> <span>100.0%</span></td></tr></tbody></table> </td> </tr>
        ...
        <div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);background:var(--global-pure-theme-color);">
            <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark">
                <tbody>
                    ...
                    <tr> <td class="p-1 pl-2 text"> <table><tbody><tr><td><svg style="color:#3572A5;" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-dot-fill mr-2 tmp-mr-2"> <path d="M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z" fill="#3572A5"></path> </svg> <span class="color-fg-default text-bold mr-1">Python</span> <span>100.0%</span></td></tr></tbody></table> </td> </tr>
                    <tr>{% include figure.liquid loading="eager" path="https://raw.githubusercontent.com/pranavraj575/sperners_lemon/refs/heads/main/img/sperners_lemon.gif" sizes = "200px" class="preview z-depth-1" zoomable=true avoid_scaling=true alt="https://raw.githubusercontent.com/pranavraj575/sperners_lemon/refs/heads/main/img/sperners_lemon.gif" %}</tr>
                </tbody>
            </table>
        </div>
    </div>
        ...
        <div class="card mt-3 p-3" style="border-radius:1rem;border:1px solid var(--global-text-color);background:var(--global-pure-theme-color);">
            <table class="table table-cv table-sm table-borderless table-responsive table-cv-map table-dark">
                <tbody>
                    ...
                    <tr> <td class="p-1 pl-2 text"> Lightweight repository for building torch networks from a config file </td> </tr>
                    <tr> <td class="p-1 pl-2 text"> <table><tbody><tr><td><svg style="color:#3572A5;" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-dot-fill mr-2 tmp-mr-2"> <path d="M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z" fill="#3572A5"></path> </svg> <span class="color-fg-default text-bold mr-1">Python</span> <span>100.0%</span></td></tr></tbody></table> </td> </tr>
