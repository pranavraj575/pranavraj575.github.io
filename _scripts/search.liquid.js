          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/aminals/" -%}{%- assign url = "/aminals/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/aminals/" -%}{%- assign url = "/aminals/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
    ...
    {%- for social in site.data.socials -%}
      {%- case social[0] -%}
        ...
        {%- when "email" -%}
          ...
          {%- capture social_url %}"mailto:{{ social[1].normal_email | encode_email }}"{% endcapture -%}
        {%- when "facebook_id" -%}
