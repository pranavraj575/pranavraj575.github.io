...
// Toggle through light, and dark.
// do not let user swap back to system after clicking toggle once
...
let determineThemeSetting = () => {
  ...
  if (themeSetting != "dark" && themeSetting != "light" && themeSetting != "system" && themeSetting != "abomination") {
    themeSetting = "system";
  }
  return themeSetting;
};
